...
const ContactSales = () => {
  ...
  return (
    <SecondaryLayout
      title={routerName.contactSales.title}
      breadcrumbs={breadcrumbs}
    >
      <div
        className={cx(
          "lg:bg-[linear-gradient(to_right,#FFF_0%,#FFF_65%,#2A437D_65%,#2A437D_100%)] bg-[linear-gradient(130deg,#FFF,#2a437d5c)]"
        )}
      >
        <div
          className={cx(
            "grid lg:grid-cols-12 lg:gap-[85px] gap-8 container lg:py-20 py-8"
          )}
        >
          <div className={cx("lg:col-span-5 px-4 lg:px-0")}>
            ...
            <div className={cx("text-sm lg:text-base lg:mt-6 mt-4")}>
              Ezbuy Japan tạo ra cầu nối thương mại điện tử giữa Nhật Bản và các
              quốc gia khác trên toàn thế giới bằng việc cung cấp các giải pháp
              hỗ trợ toàn diện, bao gồm: thương mại điện tử xuyên biên giới, vận
              chuyển quốc tế, xử lý đơn hàng tại kho và bán hàng ra các nước.
            </div>
            <div className={cx("grid gap-5 mt-4")}>
              <div className={cx("flex items-center")}>
                <img
                  src={Group_b5f0e51077 ?? ""}
                  alt="Group_b5f0e51077"
                  className={cx("text-transparent max-w-6 max-h-6 w-6 h-6")}
                />
                <div className={cx("text-sm ml-3")}>
                  Cung cấp giải pháp toàn diện với mức giá phải chăng
                </div>
              </div>
            </div>
            <div className={cx("lg:mt-10 mt-5 flex items-center")}>
              ...
              />
              <div className={cx("text-sm ml-3")}>
                Hỗ trợ đa ngôn ngữ 24/7 với khách hàng quốc tế
              </div>
            </div>
            <div className={cx("lg:mt-10 mt-5 flex items-center")}>
              <img
                src={Group_90b1fe3f5d ?? ""}
                alt="Group_90b1fe3f5d"
                className={cx("text-transparent max-w-6 max-h-6 w-6 h-6")}
              />
              <div className={cx("text-sm ml-3")}>
                ...
                <div>
                  <span>Truy cập</span>
                  <a
                    className={cx("text-[#F5222D] font-medium underline")}
                    href="https://ezbuyjapan.gitbook.io/help-center/"
                  >
                    Trung tâm hỗ trợ
                  </a>
                  <span>hoặc liên hệ qua email: </span>
                  <span className={cx("text-[#F5222D] font-medium")}>
                    admin@ezbuy.jp
                  </span>
                </div>
              </div>
            ...
            <div>
              <img
                src={Frame_427318597_695f4ecd4b ?? ""}
                alt="Frame_427318597_695f4ecd4b"
              ...
              <div className={cx("shadow-6 p-6 rounded-xl bg-white")}>
                <div className={cx("flex justify-between items-center")}>
                  ...
                  <div className={cx("text-[#666] text-xs lg:text-sm")}>
                    <span
                      className={cx(
                        "text text-[#F5222D] text-base font-medium"
                      )}
                    >
                      *{" "}
                    </span>
                ...
                <div className={cx("text-[#666] text-sm")}>
                  Vui lòng điền đầy đủ thông tin vào bảng và đội ngũ của chúng
                  tôi sẽ liên hệ với bạn trong vài giờ.
                </div>
                <div className={cx("flex items-center mt-3 lg:mt-5")}>
                  <div className={cx("font-bold mr-2 text-lg")}>
                    Thông tin liên hệ
                  </div>
                ...
                <div>
                  <div className={cx("lg:mt-4 mt-3 grid lg:grid-cols-2 gap-4")}>
                    <div>
                      <div className={cx("text-sm")}>
                        Họ tên{" "}
                        <span className={cx("font-medium text-[#F5222D]")}>
                          {" "}
                          *
                        </span>
                      </div>
                      <div
                        className={cx(
                          "border-[#ddd] border rounded-lg py-3 px-4 mt-2"
                        )}
                      >
                        <input
                          placeholder="Ví dụ: Huyền Phương"
                          className={cx("form-control form-input text-sm")}
                          type="text"
                    ...
                    <div>
                      ...
                      <div
                        className={cx(
                          " border-[#ddd] border rounded-lg py-3 px-3 mt-2"
                        )}
                      >
                        <input
                          className={cx(
                            "form-control form-input text-sm w-full"
                          )}
                          placeholder="Ví dụ: huyenphuong@gmail.com"
                          type="text"
                          {...register("email", {
                  ...
                  <div className={cx("lg:mt-4 mt-3 grid lg:grid-cols-2 gap-4")}>
                    ...
                    <div>
                      ...
                      <div
                        className={cx(
                          "border border-[#ddd] rounded-lg py-3 px-4 mt-2"
                        )}
                      >
                        <input
                          className={cx("form-control form-input text-sm")}
                          placeholder="Nhập vị trí công việc của bạn"
                          type="text"
                ...
                <div>
                  {/* <span className={cx("text-xs lg:text-sm")}>
                    Chọn vai trò của bạn
                  </span> */}
                  {/* <span className={cx("font-medium text-[#F5222D]")}> *</span>
                  <div className={cx("flex gap-5 mt-2")}>
                    <label
                      className={cx("flex ml-1 cursor-pointer")}
                      htmlFor="buyers"
                    >
                      <input
                        className={cx("custom-control-input mr-2 scale-[1.5]")}
                      ...
                      />
                      <div className={cx("text-sm lg:text-base")}>
                        Người mua
                      </div>
                    </label>
                    <label
                  ...
                  {errors.role && (
                    <div
                      className={cx("text-xs lg:text-sm text-[#F5222D] mt-1")}
                    >
                      {errors.role.message}
                    </div>
                  )} */}
                      ...
                      render={({ field }) => (
                        <Select
                          ...
                          classNames={{
                            input: () =>
                              cx(
                                "w-full text-inherit opacity-100 min-w-0.5 border-0 outline-0 m-0 p-0"
                              ),
                ...
                <div className={cx("mt-4")}>
                  ...
                  >
                    <textarea
                      ...
                      className={cx(
                        "form-control form-input text-sm w-full outline-0"
                      )}
                ...
                <div className={cx("lg:mt-5 mt-3 lg:flex")}>
                  <div className={cx("text-sm")}>
                    <span>
                      Bằng cách gửi biểu mẫu này, tôi xác nhận chấp nhận
                    </span>
                    <span className={cx("text-[#F5222D] font-medium")}>
                      {" "}
                      Chính sách bảo mật
                    </span>
                    <span> của Ezbuy Japan</span>
                  </div>
                  <button
                    className={cx(
                      "cursor-pointer lg:ml-10 mt-4 lg:mt-0 w-full",
        ...
        <section
          className={cx(
            "flex flex-col lg:flex-row gap-5 px-4 lg:px-0 w-full py-6 lg:py-10 justify-end"
          )}
        >
          <div className={cx("lg:max-w-[395px]")}>
            ...
            <Link
              className={cx("text-[#F5222D] text-sm lg:text-base group block")}
              to="/"
            >
              ...
              <FontAwesomeIcon
                icon={faArrowRight}
                className={cx(
                  "svg-inline--fa fa-arrow-right ml-2 group-hover:ml-3 transition-all"
                )}
              />
            </Link>
          </div>
          <div className={cx("lg:w-[60%] flex flex-col justify-center")}>
            <div
              className={cx(
                "relative z-10 lg:[mask-image:linear-gradient(-90deg,_#FFF_96%,_rgba(_255,-255,_255,_0)_97%,_rgba(_255,_255,_255,_0.32)_110%)] flex flex-col gap-4 lg:gap-7"
              )}
            >
